		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Excel Upload to Table",
									"targetURL": "#exceluploadtotable-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"exceluploadtotable-display": {
								"semanticObject": "exceluploadtotable",
								"action": "display",

								"title": "Excel Upload Test_V1",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									"applicationType": "SAPUI5",
									"additionalInformation": "SAPUI5.Component=exceluploadtotable",
									"url": sap.ui.require.toUrl("exceluploadtotable")
								}
							}
						}
					}
